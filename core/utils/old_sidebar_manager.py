...
def setup_sidebar(app, pages, show_page):
    ...
    ttk.Label(sidebar, text="PowDroid", font=("Segoe UI", 16, "bold")).pack(
        pady=(20, 10)
    )
    ...
    ttk.Button(
        sidebar, text="Home", style="primary.TButton", takefocus=0, command=go_home
    ...
    ttk.Button(
        sidebar, text="Help", style="primary.TButton", takefocus=0, command=open_help
    ).pack(fill="x", padx=10, pady=5)
    ttk.Button(
        sidebar,
        text="Report Issue",
    ...
    ttk.Button(
        sidebar, text="Exit", style="primary.TButton", takefocus=0, command=on_exit
    ).pack(fill="x", padx=10, pady=5)
